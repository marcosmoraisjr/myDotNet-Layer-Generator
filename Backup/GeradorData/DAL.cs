    ...
    public class DAL
    {
        ...
        public StringBuilder GerarClasseDadosPersistencia(String[] _tabelas, String _conexao, String _banco, String _namespace)
        {
            ...
            foreach (string strTabela in _tabelas)
            {
                ...
                objCodigo.AppendLine("              {");
                objCodigo.AppendLine("                  throw new Exception(\"Ocorreu um erro. Entre em contato com o administrador do sistema. \"+Err.ToString());");
                objCodigo.AppendLine("              }");
                objCodigo.AppendLine("          }");
                objCodigo.AppendLine("      }");
                objCodigo.AppendLine("  }");
                ...
                #region classe apagar com retorno
                // DELETE ////////////////////////////////////////////////////////////////////////////////////////
                objCodigo.AppendLine();
                objCodigo.AppendLine("  /// <summary>");
                ...
                #region classe procurar via condição
                // MÉTODO FindByQuery ========================================================================
                objCodigo.AppendLine();
                objCodigo.AppendLine("      /// <summary>");
                objCodigo.AppendLine("      /// MARCOS:");
                ...
                #region classe procurar tudo (listar)
                // MÉTODO FindAll =================================================================================
                objCodigo.AppendLine();
                objCodigo.AppendLine("      /// <summary>");
                objCodigo.AppendLine("      /// MARCOS:");
                ...
                #region classe procurar tudo ordenando
                ...
                #region classe procurar tudo, ordenando e direcionando (crescente ou decrescente)
                ...
                #region classe procurar tudo com condição
                ...
                #region classe procurar tudo, ordenando e direcionado
                ...
                #region classe procurar por campo
