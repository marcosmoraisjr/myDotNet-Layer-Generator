...
namespace Gerador
{
    public partial class Principal : Form
    {
        ...
        private void ListarTabelas()
        {
            ...
            {
                Library.Message.Processando("Aguarde", "Processando...");
            });
            thr.Start();
            ...
            if (ChecaLeitura())
            {
                if (ListBoxTabelas.SelectedItems.Count != 0)
                {
                    ...
                    thr.Start();
                    {
                        ...
                        Gerador.Business.Business objGeradorBLL = new Gerador.Business.Business();
